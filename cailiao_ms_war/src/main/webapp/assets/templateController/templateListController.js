...
function operateFormatter(value, row, index) {
	if (value == 0) {
		return [
				'<input type="button" value="编辑" class="btn waves-effect waves-light blue" disabled="disabled" id="List',
				row.id, '" >' ].join('');
	} else {
		return [
				'<input type="button" value="编辑" class="btn waves-effect waves-light blue" id="List',
				row.id, '">' ].join('');
	}
};
