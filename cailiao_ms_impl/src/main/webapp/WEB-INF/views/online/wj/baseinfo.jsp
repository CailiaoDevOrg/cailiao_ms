...
<div class="box box-solid box-info">
	<div class="box-header">
          <h3 class="box-title" style="color:#fff; font-weight:600">基本信息</h3>
    </div>
	<div class="box-body">
	    <div class="row">
	        <div class="col-md-6">
	            <div class="form-group">
	                <label for="bi_qyName">企业名称<span class="redtag">*</span></label>
	                <input type="text" class="form-control" id="bi_qyName" placeholder="请输入企业名称">
	            </div>
	            <div class="form-group">
	                <label for="bi_scLineName">生产线名称<span class="redtag">*</span></label>
	        ...
	        <div class="col-md-6">
	            <div class="form-group">
	                <label for="bi_qyAddress">企业所在地址<span class="redtag">*</span></label>
